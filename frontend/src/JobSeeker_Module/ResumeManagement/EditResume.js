  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <main className="flex-1 p-4">
        <form onSubmit={handleSubmit} className="w-full max-w-lg mt-4 bg-white p-4 rounded shadow-md">
          <h2 className="text-xl font-bold mb-4">Resume Information</h2>
          <div className="flex flex-wrap -mx-3 mb-6">
            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
              <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">User ID</label>
              <input
